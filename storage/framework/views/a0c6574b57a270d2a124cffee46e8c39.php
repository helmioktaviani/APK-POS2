...
<?php if(!empty($produk->foto)): ?>
    <div class="mb-3">
        ...
        <img src="<?php echo e(asset('storage/' . $produk->foto)); ?>" width="150" class="img-thumbnail rounded shadow-sm">
    </div>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\APK-POS2\resources\views/produk/_form.blade.php ENDPATH**/ ?>