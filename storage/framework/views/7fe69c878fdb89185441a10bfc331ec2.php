...
<?php if(!empty($produk->foto)): ?>
    <div class="mb-2">
        ...
        <img src="<?php echo e(asset('storage/' . $products->foto)); ?>"
                width="150"
                class="img-thumbnail">
    </div>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
            value="<?php echo e(old('name', $produk->harga_beli  ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
            value="<?php echo e(old('name', $produk->harga_jual  ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
            value="<?php echo e(old('name', $produk->stok  ?? '')); ?>">
...
</script><?php /**PATH C:\laragon\www\APK-POS2\resources\views/Produk/_form.blade.php ENDPATH**/ ?>